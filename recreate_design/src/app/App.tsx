...
function HeroSection({ onScheduleDemo }: { onScheduleDemo: () => void }) {
  return (
    <section className="relative pt-9 pb-9 overflow-visible" style={{
      background: `
        radial-gradient(ellipse 75% 90% at 0% 50%, rgba(255,255,255,.14) 0%, rgba(255,255,255,.04) 28%, transparent 46%),
        #080808
      `,
      borderTop: '1px solid #222'
    }}>
      {/* Dot grid: strong at left viewport edge, fades to invisible before headline ends (~mid content band) */}
      <svg className="absolute inset-0 w-full h-full pointer-events-none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <defs>
          ...
          <linearGradient id="hero-dot-fade" x1="0%" y1="0%" x2="100%" y2="0%" gradientUnits="objectBoundingBox">
            <stop offset="0%" stopColor="white" stopOpacity="1"/>
            <stop offset="22%" stopColor="white" stopOpacity="0.55"/>
      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-12 flex flex-col md:flex-row gap-8 md:gap-6 items-center md:items-center justify-between reveal overflow-visible">
        <div className="flex-1 md:min-w-0 text-center md:text-left md:flex-shrink-0">
        ...
        <div className="reveal flex-shrink-0 flex justify-center md:justify-end w-full max-w-[100%] md:max-w-[48%] overflow-visible">
          <div
            className="w-full max-w-[min(100%,520px)] rounded-2xl p-[1.5px] shadow-[inset_0_1px_0_rgba(255,255,255,0.32),0_0_0_1px_rgba(255,255,255,0.08),0_8px_0_rgba(255,255,255,0.04),0_16px_48px_rgba(0,0,0,0.42)]"
            style={{
              background:
                'linear-gradient(145deg, rgba(255,255,255,0.48) 0%, rgba(255,255,255,0.12) 38%, rgba(255,255,255,0.05) 100%)',
            }}
          >
            <img
              src="/hero-product-screenshot.png"
              alt="Notch K&D client file preview"
